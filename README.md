...
*Developer Note: The current software code serves as a functional foundation. Exact angles, pressure wastegate curves, and microsecond timings can be fine-tuned via the **1-to-9 developer tuning scale (multipliers)** located in `AeroAnchorConfig.h` based on data analysis and physical testing.*
